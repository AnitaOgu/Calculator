...
public class Calculator extends JFrame implements ActionListener {
   ...
   static JFrame frame;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        String action = e.getActionCommand();// String representing the action command
        ...
        }else if ( !first.equalsIgnoreCase("") && action.charAt(0) == '='&&!second.equalsIgnoreCase("")) {
